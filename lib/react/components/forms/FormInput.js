...
class FormInput extends React.Component {
	...
	renderField() {
		let { helperText, placeholder, defaultValue, intent, type, disabled, value, readOnly, leftIconName, rightElement } = this.props;
		return (
			<div class='pt-form-content'>
				<InputGroup id={this.props.id}
