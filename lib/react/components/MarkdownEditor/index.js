...
class MarkdownEditor extends React.Component {
	...
	render() {
		let onChange = this.props.content ? this.props.onChange : this.handleEditorChange;
		let readOnly = onChange ? false : true;
			...
			<div className='markdown editor'>
				...
				>
					...
					<Tab2 id='editor' title='Editor' 
						panel={<MarkdownInput src={this.props.content || this.state.content} 
							onChange={onChange} readOnly={readOnly}/>}/>
					{this.props.hidePreview ? null :
						<Tab2 id='renderer' title='Preview' 
							panel={<MarkdownRenderer className='markdown-content' src={this.props.content || this.state.content}/>}/> }
					{this.props.hideHelp ? null :
						<Tab2 id='help' title='Help' 
							panel={<MarkdownRenderer className='help' src={MarkdownReference}/>}/> }
					<Tabs2.Expander />
				</Tabs2>
			</div>
		);
